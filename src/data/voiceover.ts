...
export const VOICEOVER: Record<string, string[]> = {
  ch0: [
    ...
    'Nine short chapters, about half an hour. One idea each, and a little toy version of it right here so you can feel it once.',
    'Then the real work happens on your Switch. Every chapter ends with a card telling you exactly what to go and practise. That is the course. This is just the classroom.',
  ...
  ch5: [
    ...
    "She doesn't drift. She doesn't do anything clever with items. She takes no risks whatsoever. And she beats {rival}. Regularly.",
    "All she does is drive a tidy line and pick up coins. That's it. That is the whole thing, and the proof of it is sitting in your own family.",
    'So. Coins. Ten of them and your kart is genuinely faster. Not a trick, not a myth — more top speed, for picking things up off the road. Almost nobody bothers.',
    "They're armour as well. Every time something hits you, you lose three of them. Which is one more reason to be carrying that banana from chapter two.",
    "Then the line. Same line every lap, until it is boring. Boring is the goal. Boring means you're not thinking, and not thinking is fast.",
    "The drill paints a good line on the road for you and then fades it away as you get the hang of it. Ten coins at the finish and you've got it.",
    'This is the highest-scoring chapter in the whole course, {name}. If you take one thing away from this website, take this one. Take Kendahl.',
  ],

  ch6: [
    'Right. Drifting. The famous one. The one everybody goes on about.',
    "And I'll be straight with you: it's the one you need least. That is why it is chapter six and not chapter one.",
    'Here is what it actually is. You hold the drift button through a corner and the kart slides round it instead of steering round it. Sparks come off the back wheels. Blue first, then orange. Let go while they are glowing and you fire out of the corner.',
    'With your steering assist switched on, blue and orange both still work. There is a third one, purple, that your settings turn off. You are not missing anything you need.',
    "Where it pays is long sweeping corners. Where it doesn't is tight ones, or traffic, or anywhere you'd rather just drive the corner properly.",
    ...
    'No drill this time. Nothing to press. Watch the diagram, watch the clip, and if it all sounds like too much then skip it. Genuinely. Kendahl does.',
  ],
